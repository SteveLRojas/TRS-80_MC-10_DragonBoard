...
//**************************************************
module PS2_keyboard(input logic clk, reset, input logic ps2_clk_d, ps2_data_d, output logic[7:0] key_code, kb_data, output logic ps2_clk_q, ps2_data_q, kb_ready, ctrl, alt);
logic[7:0] rx_data;
logic[7:0] tx_data;
logic rx_ready;
logic tx_ready;
...
assign kb_data = tx_ready ? tx_data : rx_data;
assign kb_ready = tx_ready | rx_ready;
assign ctrl = ~control_key;
assign alt = ~alt_key;
